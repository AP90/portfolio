...
$('.arrow').on('click', function () {
    $(
        '.project1-page, .project2-page, .project3-page, .project4-page, .project5-page, .project6-page, .skillspage, .aboutpage, .contactpage'
...
function fadeEverything() {
    $(
        '.project1-page, .project2-page, .project3-page, .project4-page, .project5-page, .project6-page, .skillspage, .aboutpage, .contactpage, .homepage'
    ).fadeOut('fast');
}
...
$('.copyright-col__text').text(`© ${year} Adam Pugh`);
